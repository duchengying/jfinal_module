...
<body>
	<div class="manage_container">
		...
		<div class="main">
			<h1>Blog管理&nbsp;&nbsp;
				<a href="/j-web-beetlsql/blog/add">创建Blog</a>
			</h1>
			<div class="table_box">
				<table class="list">
					<tbody>
						...
						<c:if test="${!empty blogPage.list }">
							<c:forEach items="${blogPage.list }" var="blog">
								<tr>
									...
									<td style="text-align: left;">
										&nbsp;&nbsp;<a href="/j-web-beetlsql/blog/delete/${blog.id }">删除</a>
										&nbsp;&nbsp;<a href="/j-web-beetlsql/blog/edit/${blog.id }">修改</a>
										&nbsp;&nbsp;<a href="/j-web-beetlsql/blog/view/${blog.id }">查看</a>
									</td>
				 				</tr>
							</c:forEach>
						</c:if>
				...
				<c:set var="actionUrl" value="/j-web-beetlsql/blog/"/>
				<c:set var="urlParas" value=""/>
				
				<%@ include file="/view/comm/_paginate.jsp"%>
			</div>
		</div>	
	</div>
</body>
